...
class TestIntentResolverIntegration(unittest.TestCase):
    ...
    def test_resolve_intent_get_smells_real_selector(self, mock_requests_get):
        """
        Testa IntentResolver con ToolSelector per GetSmells.
    ...
    def test_resolve_intent_get_smells_date_real_selector(self, mock_requests_get):
        """
        Testa IntentResolver con ToolSelector per GetSmellsDate.
    ...
    def test_resolve_intent_geodispersion_real_selector(self, mock_requests_post):
        """
        Testa IntentResolver con ToolSelector per Geodispersion.
        """
    ...
    def test_resolve_intent_community_inspector_analyze_real_selector(self, mock_requests_post):
        """
        Testa IntentResolver con ToolSelector per CommunityInspectorAnalyze.
        """
        mock_response_post = MagicMock()
        mock_response_post.status_code = 200
    ...
    def test_resolve_intent_community_inspector_results_real_selector(self, mock_requests_get):
        """
        Testa IntentResolver con ToolSelector per CommunityInspectorResults.
        """
    ...
    # I test per Info e Report non usano ToolSelector né tool esterni
